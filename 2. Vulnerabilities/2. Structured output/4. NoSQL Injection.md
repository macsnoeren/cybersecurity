...
## Steps
1. Set up mock NoSQL database with user and product data
2. Show normal query operations
3. Demonstrate authentication bypass using $ne operator
4. Show username enumeration with regex injection
5. Demonstrate data extraction using exists operators
6. Show how complex queries can access unauthorized data
7. Implement and test safe version with input validation
...
🛍️ Available products:
  ...
  - Secret Product ($0.01) - internal

======================================================================

🚨 VULNERABLE VERSION - NoSQL Injection Attacks:
--------------------------------------------------
...
⚠️  Result: Success
🚨 SECURITY BREACH: Bypassed authentication without valid credentials!
...
⚠️  Result: Success
🚨 USERNAME ENUMERATION: Found matching users!
🔓 Found user: admin
...
📦 Found 2 products:
  - Product B - N/A
  - Secret Product - DO NOT SELL
🚨 INTERNAL DATA EXPOSED!

======================================================================

✅ SAFE VERSION - Input Validation:
----------------------------------------

📋 Test 7: Safe login with object injection attempt
✅ Blocked: Invalid input types

📋 Test 8: Safe product search
📦 Safe search result: Found 0 products
